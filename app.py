...
def add_project():
    ...
    if request.method == 'POST':
        try:
            ...
            project_id = request.form['projectID'] .get('projectID','default_value')
...
@app.route('/')
def home():
    return render_template('index.html')  # Or the appropriate template
...
@app.route('/view_guidelines', methods=['GET'])
def view_guidelines():
    # Logic to fetch or render guidelines
    return render_template('guidelines.html') # Ensure this HTML file exists in the templates folder
